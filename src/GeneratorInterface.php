...
interface GeneratorInterface
{
     ...
     * @param array<string, bool|int|string|array|\BackedEnum|null> $options   An array of options for this generation only
     ...
     *
     * @param string                                                $input   The input HTML filename or URL
     * @param array<string, bool|int|string|array|\BackedEnum|null> $options An array of options for this output only
     */
